...
<body>
    <h1>Input Data Tiket Pesawat</h1>
    <form action="<?= base_url('lat1/simpan') ?>" method="post">
        ...
        <label>Kelas:</label>
        <input type="radio" name="kelas" value="Bisnis" required> Bisnis
        <input type="radio" name="kelas" value="Ekonomi" required> Ekonomi
        <input type="radio" name="kelas" value="Eksklusif" required> Eksklusif<br>

        <label for="jml_tiket">Jumlah Tiket:</label>
        <select name="jml_tiket" id="jml_tiket">
            <?php for ($i = 1; $i <= 10; $i++) { ?>
        ...
        <input type="text" name="total" id="total_harga" readonly><br>
